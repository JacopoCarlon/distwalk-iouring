...
TMP=$(mktemp /tmp/dw-node-test_skip-1-XXX.txt)
...
TMP=$(mktemp /tmp/dw-node-test_skip-2-XXX.txt)
node_bg &> $TMP
...
TMP=$(mktemp /tmp/dw-node-skip-every-test_skip-3-XXX.txt)
...
#
echo "TEST SKIP PROB"
TMP=$(mktemp /tmp/dw-node-skip-prob-test_skip-4-XXX.txt)
...
TMP1=$(mktemp /tmp/dw-node1-fwd-skip-test_skip-5-XXX.txt)
TMP2=$(mktemp /tmp/dw-node2-fwd-skip-test_skip-6-XXX.txt)
...
TMP1=$(mktemp /tmp/dw-node1-fwd-fwd-skip-test_skip-7-XXX.txt)
TMP2=$(mktemp /tmp/dw-node2-fwd-fwd-skip-test_skip-8-XXX.txt)
TMP3=$(mktemp /tmp/dw-node3-fwd-fwd-skip-test_skip-9-XXX.txt)
